 ...
 * (`out/docs/reference/eslint-rule-no-direct-time-randomness.md`), served as text/markdown.
 *
...
export async function GET() {
  const page = source.getPage(['reference', 'eslint-rule-no-direct-time-randomness']);
  if (!page) {
