 ...
 * (`out/docs/reference/rule-dual-implementation-discipline.md`), served as text/markdown.
 *
...
export async function GET() {
  const page = source.getPage(['reference', 'rule-dual-implementation-discipline']);
  if (!page) {
