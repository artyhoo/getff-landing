 ...
 * (`out/docs/reference/eslint-rule-restricted-syntax-audit-exempt.md`), served as text/markdown.
 *
...
export async function GET() {
  const page = source.getPage(['reference', 'eslint-rule-restricted-syntax-audit-exempt']);
  if (!page) {
