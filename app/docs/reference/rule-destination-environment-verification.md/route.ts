 ...
 * (`out/docs/reference/rule-destination-environment-verification.md`), served as text/markdown.
 *
...
export async function GET() {
  const page = source.getPage(['reference', 'rule-destination-environment-verification']);
  if (!page) {
