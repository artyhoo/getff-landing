 ...
 * (`out/docs/reference/rule-recommendation-laziness-discipline.md`), served as text/markdown.
 *
...
export async function GET() {
  const page = source.getPage(['reference', 'rule-recommendation-laziness-discipline']);
  if (!page) {
