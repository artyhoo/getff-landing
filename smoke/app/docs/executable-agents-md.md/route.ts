...
/**
 * D4: raw-Markdown twin of the docs page — a REAL file in the static export
 * (`out/docs/executable-agents-md.md`), served as text/markdown.
 *
...
export async function GET() {
  const page = source.getPage(['executable-agents-md']);
  if (!page) {
